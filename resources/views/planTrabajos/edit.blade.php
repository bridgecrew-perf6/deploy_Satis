            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input required type="text" name="sprint" value="{{ $planTrabajo->sprint }}"
                            class="form-control" placeholder="N° Sprint del proyecto">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input required type="date" name="fecha_inicio" class="form-control"
                            placeholder="{{ $planTrabajo->fecha_inicio }}" value="{{ $planTrabajo->fecha_inicio }}">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input required type="date" name="fecha_fin" class="form-control"
                            placeholder="{{ $planTrabajo->fecha_fin }}" value="{{ $planTrabajo->fecha_fin }}">
                    </div>
                </div>
                ...
                <div class="col-md-6 d-flex justify-content-between ">
                    <button type="submit" class="btn btn-primary"
                        style="background-color: #215f88;margin-top: 50px;">Guardar</button>
                </div>
            </div>
