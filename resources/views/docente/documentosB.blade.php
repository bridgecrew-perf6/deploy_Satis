...
<div class="container mt-5 formulario">
 ...
 <form class="row g-3"  method="post" action="{{ route('docente.subirDocuB') }}" enctype="multipart/form-data">
...
<div class="col-md-12">
     ...
     <textarea name="name" class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px"></textarea>
   </div>
