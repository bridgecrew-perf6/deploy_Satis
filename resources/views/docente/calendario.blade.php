...
<div class="container">
    <br />
    <h1 class="text-center text-primary"><u>Calendario docente</u></h1>
    <br />
...
$(document).ready(function () {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        {
            if(confirm("¿Seguro que quiere borrar este evento?"))
            {
                var id = event.id;
                $.ajax({
                    url:"../docente/calendario/action",
