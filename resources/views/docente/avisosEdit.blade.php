...
<body>
    ...
    <div class="container mt-5 formularioDocu">
        <div class="formCyA">
            ...
            <form class="row g-3" method="post" action="{{ route('avisos.update', $avisos) }}"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-4">
                    <label  class="form-label">Titulo:</label>
                    <input type="text"  class="form-control"value="{{$avisos->name}}" name="name" required>
                    
                    </div>
                    <div class="form-floating">Descripcion:
                    <textarea name="descripcion" class="form-control" placeholder="" id="floatingTextarea2"
                        style="height: 100px">{{$avisos->descripcion}}</textarea>
                </div>
                </div>
